...
var GameWrap = React.createClass({
    ...
    render: function () {
        ...
        var game = newGame ? <Game newGame={newGame} game={this.state.game} questions={this.state.questions} gameOver={this.newPanel}/> : null

        return (
            <div>
                <SavePanel next={this.nextGamePanel} style={styleSave} data={this.state.game}/>
                <NewGamePanel styleNext={styleNext} newGame={this.newGame}/>
                {game}
            </div>
        )
    }
...
var Game = React.createClass({
    ...
    render: function () {
        return (
            <div className="game">
                <QuestionPanel question={this.state.question}/>
                <TimerBar width={this.state.timer}/>
                <ChampionBoard champions={this.state.champions} gameController={this.gameController}/>
                <InfoBoard lives={this.props.game.lives} difficulty={this.props.game.difficulty} points={this.props.game.points}/>
            </div>
        )
    }
});

React.render(<GameWrap/>,
 document.getElementById('game-wrap'));
React.render(<ScoreBoard/>,
